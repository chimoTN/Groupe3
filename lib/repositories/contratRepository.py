...
class Contrat:
    ...
    def __init__(self, client: Client, vehicule: Vehicule, date_debut: date, 
        ...
        self.est_actif = True
        self.id = None  # Sera défini lors de l'enregistrement
        
        # Lier le véhicule au client
...
class ContratRepository:
    ...
    def _initialize(self):
        ...
        # Simulation d'une base de données avec une liste de contrats
        self._contrats = {}
        self._next_id = 1
    ...
    def save(self, contrat: Contrat) -> int:
        ...
        Returns:
            L'ID du contrat
        """
        # Vérifier si le contrat a déjà un ID
        if contrat.id is None:
            contrat.id = self._next_id
            self._next_id += 1
        
        # Sauvegarder ou mettre à jour le contrat
    ...
    def delete(self, contrat_id: int) -> bool:
        ...
        if contrat:
            # Si le contrat est actif, il faut d'abord retourner le véhicule
    ...
    def close_contract(self, contrat_id: int, km_parcourus: int) -> bool:
        ...
        if contrat and contrat.est_actif:
            ...
            # Marque le contrat comme inactif
            contrat.est_actif = False
            return True
        return False
    ...
    def create_contrat(self, client: Client, vehicule: Vehicule, 
        ...
        # Calcul du coût et de la caution
        cout_total = vehicule.prix_journalier * duree
        caution = cout_total * 0.10  # 10% du coût total
        ...
        # Lier le véhicule au client et ajouter à l'historique
